...
class Fighter: #Class for the fighters 
    def __init__ (self,x,y,r,g,w,h,F,dir):
        ...
        self.blackf= loadImage(path+ '/images/blackframes.png') #load images for all characters with different colors
        self.redf= loadImage(path+ '/images/redframes.png')
        self.greenf= loadImage(path+ '/images/greenframes.png')
        self.bluef= loadImage(path+ '/images/blueframes.png')
...
class Game: #class for the whole game
    def __init__(self,w,h,g):
        ...
        self.h=h
        self.g=g
        self.bg1=loadImage(path+'/images/background.png')    #load backgrounds, fighter images, control images, health bar image, leaderboard image
        self.bg2=loadImage(path+'/images/wfog.png')
        self.menu=loadImage(path+'/images/menu.png')
        self.khabib=loadImage(path+'/images/khabib.png')
        self.mcgregor=loadImage(path+'/images/mcgregor.png')
        self.dustin=loadImage(path+'/images/poirier.png')
        self.justin=loadImage(path+'/images/gaethje.png')
        self.arrows=loadImage(path+'/images/arrows.png')
        self.d_arrow=loadImage(path+'/images/downarrow.png')
        self.wasd=loadImage(path+'/images/wasd.png')
        self.c_key=loadImage(path+'/images/c.png')
        self.v_key=loadImage(path+'/images/v.png')
        self.s_key=loadImage(path+'/images/s.png')
        self.period=loadImage(path+'/images/period.png')
        self.slash=loadImage(path+'/images/slash.png')
        self.health=loadImage(path+'/images/healthsquare.png')
        self.l_image=loadImage(path+'/images/leaderboard.png')
        ...
        self.frames=0    
        self.crowd=minim.loadFile(path+'/sounds/crowdnoise.mp3')   #load crowd noise, punch noise, winning commentary
        self.punch=minim.loadFile(path+'/sounds/punch.mp3')
        self.itstime=minim.loadFile(path+'/sounds/itstime.mp3')
        self.p1=minim.loadFile(path+'/sounds/poirier1.mp3')
        self.p2=minim.loadFile(path+'/sounds/poirier2.mp3')
        self.p3=minim.loadFile(path+'/sounds/poirier3.mp3')
        self.k1=minim.loadFile(path+'/sounds/khabib1.mp3')
        self.k2=minim.loadFile(path+'/sounds/khabib2.mp3')
        self.k3=minim.loadFile(path+'/sounds/khabib3.mp3')
        self.g1=minim.loadFile(path+'/sounds/gaethje1.mp3')
        self.g2=minim.loadFile(path+'/sounds/gaethje2.mp3')
        self.c1=minim.loadFile(path+'/sounds/conormcgregor1.mp3')
        self.c2=minim.loadFile(path+'/sounds/conormcgregor2.mp3')
